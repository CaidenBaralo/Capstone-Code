...
namespace Trial1
{
    public partial class RoomInput91 : Form
    {


        //Names the string "Length91" to be used later
        public string Length91;
        //Names the string "Width91" to be used later
        public string Width91;
        //Names the string "Distance" to be used later
        //public static string DistanceIn91;
        public string DistanceIn91;
        public string Zero;
        public static object Units91;
        public RoomInput91()
        {
            InitializeComponent();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
...

            {
                ...
                this.Close();
                RoomOutput91 f5 = new RoomOutput91();
