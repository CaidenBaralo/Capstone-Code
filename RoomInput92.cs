...
namespace Trial1
{
    public partial class RoomInput92 : Form
    {


        //Names the string "Length92" to be used later
        public string Length92;
        //Names the string "Width92" to be used later
        public string Width92;
        //Names the string "Distance" to be used later
        //public static string DistanceIn92;
        public string DistanceIn92;
        public string Zero;
        public static object Units92;
        public RoomInput92()
        {
            InitializeComponent();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
...

            {
                ...
                this.Close();
                RoomOutput92 f5 = new RoomOutput92();
                f5.Show();
