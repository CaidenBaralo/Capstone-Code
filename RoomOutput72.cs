...
namespace Trial1
{
    public partial class RoomOutput72 : Form
    {
        ...
        {
            this.Close();
            RoomInput72 f2 = new RoomInput72();
            f2.Show();

        }
        private void RoomOutput72_Load(object sender, EventArgs e)
        {
...

            {
                ...
                else
                {
                    ...
                    {
                        if (Variables.AIdeal <= 0 | Variables.BIdeal <= 0 | Variables.CIdeal <= 0 | Variables.DIdeal <= 0 | Variables.FIdeal <= 0 | Variables.ListenerIdeal <= 0 | Variables.HIdeal <= 0 | Variables.JIdeal <= 0)
                        {
