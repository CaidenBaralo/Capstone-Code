...
namespace Trial1
{
    public partial class RoomInput71 : Form
    {


        //Names the string "Length71" to be used later
        public   string Length71;
        //Names the string "Width71" to be used later
        public  string Width71;
        //Names the string "Distance" to be used later
        //public static string DistanceIn71;
        public string  DistanceIn71;
        public  string Zero;
        public static object Units71;
        public RoomInput71()
        {
            InitializeComponent();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
...

            {
                ...
                this.Close();
                RoomOutput71 f5 = new RoomOutput71();
